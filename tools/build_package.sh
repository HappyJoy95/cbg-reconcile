...
>
> * **已经装着 v1.6.1 的电脑**：看第一～六节。
>   「补历史数据」那件事**程序会自己做**，不用你操作。
> * **从 v1.6.0 或更早升上来的**：第七节那几条（Win7 补丁、管理员权限、
>   验证码提示）仍然适用。
>
...
**二、「运行」页现在有四个按钮，控制台第一个标签页改叫「报量排查」。**
